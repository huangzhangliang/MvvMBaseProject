package com.android.barball_library.acp;
    ...
    public static class Builder {
        ...
        public Builder setRationalMessage(String rationalMessage) {
            if (!TextUtils.isEmpty(rationalMessage)){
                this.mRationalMessage = rationalMessage;
            }
            return this;
        }
        ...
        public Builder setRationalBtn(String rationalBtnText) {
            if (!TextUtils.isEmpty(rationalBtnText)){
        ...
        public Builder setDeniedMessage(String deniedMessage) {
            if (!TextUtils.isEmpty(deniedMessage)){
                this.mDeniedMessage = deniedMessage;
            }
            return this;
        }
        ...
        public Builder setDeniedSettingBtn(String deniedSettingText) {
            if (!TextUtils.isEmpty(deniedSettingText)){
