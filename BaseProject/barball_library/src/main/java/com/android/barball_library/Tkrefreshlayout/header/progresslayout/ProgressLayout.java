package com.android.barball_library.Tkrefreshlayout.header.progresslayout;
...
import com.android.barball_library.Tkrefreshlayout.IHeaderView;
import com.android.barball_library.Tkrefreshlayout.OnAnimEndListener;
...
//        Log.d("onPullingDown","fraction:"+ fraction+" maxHeadHeight:"+ maxHeadHeight+" headHeight:"+ headHeight);
        if (!mIsBeingDragged) {
        ...
        if (fraction >= 1f) {
            ...
            ViewCompat.setScaleY(mCircleView, fraction > 0.5?fraction: (float) Math.min(0.5, fraction * 4));
        }
