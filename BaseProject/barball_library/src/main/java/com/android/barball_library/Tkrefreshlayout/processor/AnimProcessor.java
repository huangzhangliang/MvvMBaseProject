package com.android.barball_library.Tkrefreshlayout.processor;
...
import com.android.barball_library.Tkrefreshlayout.utils.ScrollingUtil;
...
public class AnimProcessor implements IAnimRefresh, IAnimOverScroll {
    ...
    public void animHeadHideByVy(int vy) {
        ...
        vy = Math.abs(vy);
        if (vy < 5000) vy = 10000;
        animLayoutByTime(getVisibleHeadHeight(), 0, 200 , animHeadUpListener, new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
    ...
    public void animBottomHideByVy(int vy) {
        ...
        vy = Math.abs(vy);
        if (vy < 5000) vy = 10000;
//        animLayoutByTime(getVisibleFootHeight(), 0, 5 * Math.abs(getVisibleFootHeight() * 1000 / vy), animBottomUpListener, new AnimatorListenerAdapter() {
//            @Override
//            public void onAnimationEnd(Animator animation) {
...
//            }
//        });
        animLayoutByTime(getVisibleFootHeight(), 0, 200, animBottomUpListener, new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                isAnimBottomHide = false;
                cp.resetBottomView();
