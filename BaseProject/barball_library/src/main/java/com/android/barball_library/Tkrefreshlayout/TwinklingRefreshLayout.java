...
import com.android.barball_library.Tkrefreshlayout.header.GoogleDotView;
import com.android.barball_library.Tkrefreshlayout.processor.AnimProcessor;
import com.android.barball_library.Tkrefreshlayout.processor.IDecorator;
import com.android.barball_library.Tkrefreshlayout.processor.OverScrollDecorator;
import com.android.barball_library.Tkrefreshlayout.processor.RefreshProcessor;
import com.android.barball_library.Tkrefreshlayout.utils.DensityUtil;
...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener {
    ...
    public void onPullingDown(float fraction) {
        ...
        if (refreshListener != null) refreshListener.onPullingDown(fraction);
    }
    ...
    public void onPullingUp( float fraction) {
        ...
        if (refreshListener != null) refreshListener.onPullingUp(fraction);
    }
    ...
    public void onPullDownReleasing(float fraction) {
        ...
        if (!enableRefresh) return;
        if (refreshListener != null)
            refreshListener.onPullDownReleasing(fraction);
    }
    ...
    public void onPullUpReleasing(float fraction) {
        ...
        if (!enableLoadmore) return;
        if (refreshListener != null) refreshListener.onPullUpReleasing(fraction);
    }
    ...
    public void onLoadMore() {
        ...
        if (refreshListener != null) refreshListener.onLoadMore();
    }
    ...
    public boolean isRefreshing(){
        return cp.isRefreshVisible();
    }


    public boolean isLoadingMore(){
        return cp.isLoadingVisible();
    }
    ...
    public class CoContext {
        ...
        public void onPullingDown(float offsetY) {
            pullListener.onPullingDown(offsetY / mHeadHeight);
        }

        public void onPullingUp(float offsetY) {
            pullListener.onPullingUp(offsetY / mBottomHeight);
        }
        ...
        public void onPullDownReleasing(float offsetY) {
            pullListener.onPullDownReleasing(offsetY / mHeadHeight);
        }

        public void onPullUpReleasing(float offsetY) {
            pullListener.onPullUpReleasing(offsetY / mBottomHeight);
        }
