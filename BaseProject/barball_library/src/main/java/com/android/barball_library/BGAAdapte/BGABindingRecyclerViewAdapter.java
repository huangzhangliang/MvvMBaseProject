...
package com.android.barball_library.BGAAdapte;
...
public class BGABindingRecyclerViewAdapter<M, B extends ViewDataBinding> extends RecyclerView.Adapter<BGABindingViewHolder<B>> {
    ...
    public void onBindViewHolder(BGABindingViewHolder<B> viewHolder, int position) {
        ...
        binding.setVariable(com.android.barball_library.BR.viewHolder, viewHolder);
        binding.setVariable(com.android.barball_library.BR.model, model);
        binding.setVariable(com.android.barball_library.BR.itemEventHandler, mItemEventHandler);
